...
import static seedu.tatoolkit.logic.commands.CommandTestUtil.VALID_CLASS_GROUP_BOB;
...
import static seedu.tatoolkit.logic.commands.CommandTestUtil.VALID_GITHUB_BOB;
...
import static seedu.tatoolkit.logic.commands.CommandTestUtil.VALID_TELEGRAM_BOB;
...
public class TypicalPersons {
    ...
    /**
     * Returns a {@code TaToolkit} with all the typical persons.
     */
    public static TaToolkit getTypicalTaToolkit() {
        TaToolkit toolkit = new TaToolkit();
        for (Person person : getTypicalPersons()) {
            toolkit.addPerson(person);
        }
        return toolkit;
    }
