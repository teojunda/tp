...
import static seedu.tatoolkit.logic.Messages.MESSAGE_INVALID_PERSON_DISPLAYED_INDEX;
...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonTaToolkitStorage taToolkitStorage =
                new JsonTaToolkitStorage(temporaryFolder.resolve("taToolkit.json"));
        JsonUserPrefsStorage userPrefsStorage = new JsonUserPrefsStorage(temporaryFolder.resolve("userPrefs.json"));
        StorageManager storage = new StorageManager(taToolkitStorage, userPrefsStorage);
    ...
    private void assertCommandFailure(String inputCommand, Class<? extends Throwable> expectedException,
            String expectedMessage) {
        Model expectedModel = new ModelManager(model.getTaToolkit(), new UserPrefs());
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        // Inject LogicManager with an TaToolkitStorage that throws the IOException e when saving
        JsonTaToolkitStorage taToolkitStorage = new JsonTaToolkitStorage(prefPath) {
            @Override
            public void saveTaToolkit(ReadOnlyTaToolkit taToolkit, Path filePath)
                    throws IOException {
                throw e;
            }
        };
        ...
        // Triggers the saveTaToolkit method by executing an add command
